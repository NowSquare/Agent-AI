...
<body class="h-full font-sans antialiased bg-slate-50 dark:bg-slate-900 selection:bg-sky-100 dark:selection:bg-sky-900">
    ...
    <div class="fixed top-4 left-4">
        <a href="{{ route('welcome') }}" class="group inline-flex items-center gap-2 rounded-full bg-white/50 px-3 py-2 text-sm text-slate-600 backdrop-blur hover:bg-white/75 dark:bg-slate-800/50 dark:text-slate-300 dark:hover:bg-slate-800/75">
    ...
    <div class="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            <div class="relative overflow-hidden rounded-2xl bg-white p-8 shadow-xl ring-1 ring-slate-200 dark:bg-slate-800 dark:ring-slate-700">
                <!-- Decorative corner -->
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            <div class="flex items-center justify-between px-2">
                ...
                <div class="flex items-center gap-3">
                    <!-- Language Selector -->
                    <div class="relative">
                        <select onchange="window.location.href = '?lang=' + this.value" class="h-9 appearance-none rounded-xl bg-white pl-3 pr-8 text-sm text-slate-700 shadow-sm ring-1 ring-slate-200 hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-sky-500 dark:bg-slate-800 dark:text-slate-300 dark:ring-slate-700 dark:hover:bg-slate-700/75">
                            @php
                        ...
                        <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2">
                            <i data-lucide="chevron-down" class="h-4 w-4 text-slate-400 dark:text-slate-500"></i>
                        </div>
                    </div>

                    <!-- Theme Toggle -->
                    <button type="button" onclick="toggleTheme()" class="inline-flex h-9 w-9 items-center justify-center rounded-xl bg-white text-slate-700 shadow-sm ring-1 ring-slate-200 hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-sky-500 dark:bg-slate-800 dark:text-slate-300 dark:ring-slate-700 dark:hover:bg-slate-700/75">
